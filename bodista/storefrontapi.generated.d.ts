...
export type ProductCardFragment = Pick<
  ...
  'id' | 'title' | 'handle'
> & {
  typeProduct?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  priceRange: {
...
export type MenuProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle'
> & {
  typeProduct?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  ...
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
        typeProduct?: StorefrontAPI.Maybe<
...
export type ShopAllProductFragment = Pick<
  StorefrontAPI.Product,
  'productType' | 'id' | 'title' | 'handle'
> & {
  collections: {
    nodes: Array<Pick<StorefrontAPI.Collection, 'handle' | 'title'>>;
  };
  keyIngredients?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  typeProduct?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  priceRange: {
    minVariantPrice: Pick<StorefrontAPI.MoneyV2, 'amount' | 'currencyCode'>;
  };
...
export type ShopAllQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type ShopAllQuery = {
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'productType' | 'id' | 'title' | 'handle'> & {
        collections: {
          nodes: Array<Pick<StorefrontAPI.Collection, 'handle' | 'title'>>;
        };
...
> & {
  ...
  howToUse?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  detailSections?: StorefrontAPI.Maybe<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment ShopAllProduct on Product {\n    ...ProductCard\n    productType\n    collections(first: 10) {\n      nodes {\n        handle\n        title\n      }\n    }\n    keyIngredients: metafield(namespace: "custom", key: "key_ingredients") {\n      value\n    }\n  }\n  query ShopAll($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 50, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...ShopAllProduct\n      }\n    }\n  }\n  #graphql\n  fragment ProductCard on Product {\n    id\n    title\n    handle\n    typeProduct: metafield(namespace: "custom", key: "type_product") {\n      value\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n  }\n\n': {
    return: ShopAllQuery;
    variables: ShopAllQueryVariables;
  };
  '#graphql\n  query Page(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      handle\n      id\n      title\n      body\n      seo {\n        description\n        title\n      }\n    }\n  }\n': {
    return: PageQuery;
